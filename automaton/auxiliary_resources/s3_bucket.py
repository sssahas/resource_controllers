...
class S3BucketStack(Construct):
    def __init__(
        self, scope: Construct, id: str, name: str, properties: dict = None
    ) -> None:
        ...
        name = f"{name.replace('_', '-')}-{str(uuid.uuid4())[:6]}"
        ...
        self.bucket = s3.Bucket(
            ...
            removal_policy=removal_policy_map.get(
                props.get("removal_policy", "destroy")
            ),
